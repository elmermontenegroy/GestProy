...
<title>Actualizar un nuevo Documento</title>
</head>
<body>

<h1>Actualizar un nuevo Documento</h1>
<s:form action="ActualizarDocumentoAction">
...
<s:if test="!documentos.isEmpty">
  ...
  <p><a href="RefrescarActualizarDocumentoAction">Salir de la vista Registrar</a></p>
</body>
</html>